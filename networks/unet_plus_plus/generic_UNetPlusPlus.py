...
class Generic_UNetPlusPlus(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, n_classes, num_pool, num_conv_per_stage=2,
        ...
        self.seg_outputs.append(conv_op(self.loc0[-1][-1].output_channels, n_classes,
                                        1, 1, 0, 1, 1, seg_output_use_bias))
        self.seg_outputs.append(conv_op(self.loc1[-1][-1].output_channels, n_classes,
                                        1, 1, 0, 1, 1, seg_output_use_bias))
        self.seg_outputs.append(conv_op(self.loc2[-1][-1].output_channels, n_classes,
                                        1, 1, 0, 1, 1, seg_output_use_bias))
        self.seg_outputs.append(conv_op(self.loc3[-1][-1].output_channels, n_classes,
                                        1, 1, 0, 1, 1, seg_output_use_bias))
        self.seg_outputs.append(conv_op(self.loc4[-1][-1].output_channels, n_classes,
                                        1, 1, 0, 1, 1, seg_output_use_bias))
